...
import { fetchInstallmentPlans } from "@/lib/api";

export default function InstallmentPlanListPage() {
      ...
      <Card>
        <CardContent className="p-4 space-y-4">
          <div className="flex gap-2">
            ...
            <Button onClick={() => router.push("/en/installment-plan/create")}>Create</Button>
          </div>
          <Table>
            <TableHeader>
              <TableRow>
