...
import { fetchCourseInstructors } from "@/lib/api";

export default function CourseInstructorListPage() {
      ...
      <Card>
        <CardContent className="p-4 space-y-4">
          <div className="flex gap-2">
            ...
            <Button onClick={() => router.push("/en/course-instructor/create")}>Create</Button>
          </div>
          <Table>
            <TableHeader>
              <TableRow>
