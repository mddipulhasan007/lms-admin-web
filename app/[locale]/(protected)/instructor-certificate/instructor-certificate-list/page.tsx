...
import { fetchInstructorCertificates } from "@/lib/api";

export default function InstructorCertificateListPage() {
      ...
      <Card>
        <CardContent className="p-4 space-y-4">
          <div className="flex gap-2">
            ...
            <Button onClick={() => router.push("/en/instructor-certificate/create")}>Create</Button>
          </div>
          <Table>
            <TableHeader>
              <TableRow>
