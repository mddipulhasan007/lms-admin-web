          ...
          {step === 1 && (
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                />
                <Input name="intro_video_check" placeholder="Intro Video Check" value={formData.intro_video_check} onChange={handleChange} />
              </div>
              {/* Intro Video Check & Video */}
              <div className="grid grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Input name="og_image" placeholder="OG Image URL" value={formData.og_image} onChange={handleChange} />
              </div>
            </div>
          )}
